...
var scrapeArticles = require("./models/scrapeArticles.js");
...
function saveScrapedArticles() {

}

app.get("/scrape", function (req, res) {
  var allFoundArticles;
  ...
  request("http://www.nytimes.com/pages/business/index.html", function (error, response, html) {
    ...
    $("div.story").each(function (i, element) {
      ...
      if (test) {
        ...
        //articles save
        var storeScrapeArticle = new scrapeArticles(result);
        //save these results to mongodb
        storeScrapeArticle.save({
            result
          },
...
app.get("/", function (req, res) {
  scrapeArticles.find({}, function(error, found) {
                      
      allFoundArticles = {found};
      ...
      // Otherwise, send the result of this query to the browser
        ...
        //  res.json(found);
        res.render("index", allFoundArticles);
      }
    });
});
